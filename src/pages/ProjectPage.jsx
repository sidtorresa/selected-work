...
export default function ProjectPage() {
  ...
  return (
    <div style={{ minHeight: '100vh' }}>
      ...
      {/* Header */}
      <header style={{ padding: 'var(--space-4xl) 0 var(--space-3xl)' }}>
        <div className="container">
          <div className="animate-in">
            <h1 style={{ marginBottom: 'var(--space-sm)' }}>{project.title}</h1>
            <p style={{ 
              fontSize: '1.25rem', 
            ...
            <p style={{ 
              ...
              {project.role} · {project.duration} · {project.industry}
            </p>
          </div>
        </div>
      </header>
      ...
      <section style={{ paddingBottom: 'var(--space-4xl)' }}>
        <div className="container">
          ...
          <div className="shift-container animate-in delay-1">
